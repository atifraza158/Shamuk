...
class ProductSellerRegisterScreen extends StatefulWidget {
  const ProductSellerRegisterScreen({super.key});

  @override
  State<ProductSellerRegisterScreen> createState() =>
      _ProductSellerRegisterScreenState();
}

class _ProductSellerRegisterScreenState
    extends State<ProductSellerRegisterScreen> {
  File? shopBanner;
