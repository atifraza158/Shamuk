...
class ProdcutDetailSlider extends StatefulWidget {
  final List items;
  final bool isEmptyy;
  String productTitle;
  String productDesc;
  ...
  @override
  _ProdcutDetailSliderState createState() => _ProdcutDetailSliderState();
}

class _ProdcutDetailSliderState extends State<ProdcutDetailSlider> {
  String type = '';
